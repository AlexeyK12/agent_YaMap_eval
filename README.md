...
![Обзор решения](assets/project_overview.svg)
...
![Сравнение результатов](assets/validation_results.svg)
...
![Локальный интерфейс агента](assets/agent_app_screenshot.png)
