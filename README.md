...
Этот репозиторий содержит решение финального проекта по оценке релевантности организаций из Яндекс.Карт широким пользовательским запросам. Примеры таких запросов: «ресторан с верандой», «романтичный джаз-бар», «спортзал с бесплатным занятием».

## Краткий итог для проверяющего
...
Для локального запуска исходные данные кладутся в:
...
reports/experiment_report.md       подробности экспериментов
